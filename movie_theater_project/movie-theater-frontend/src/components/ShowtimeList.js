...
import { fetchAuditoriums } from '../api/auditorium';
      ...
      <ul>
        ...
        {showtimes.map(st => (
          <li key={st.id}>
            ...
            <p><strong>Available Seats:</strong> {st.auditorium?.total_seats??0} seats available</p>
            <p><strong>Click To More Details:</strong></p>
            <Link to={`/showtimes/${st.id}/seats/`} className="showtime-link">
              View Seats
            </Link>
